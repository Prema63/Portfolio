...
import { Menu, X, Github, Linkedin, Mail, Phone, MapPin, ExternalLink, Code2, Database, Server, Smartphone, ChevronDown, Star } from 'lucide-react';
...
const Portfolio = () => {
  ...
  const experiences = [
    {
      ...
      description: 'Developed and maintained web applications using MERN stack. Collaborated with senior developers to implement new features and optimize existing code.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Focused on creating responsive user interfaces using React.js and modern CSS frameworks. Worked closely with design team to implement pixel-perfect designs.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Intensive training program covering full-stack development fundamentals. Built several projects to demonstrate proficiency in MERN stack technologies.',
      achievements: [
  ...
  const projects = [
    ...
    },
    {
      ...
      features: ['Real-time Updates', 'Data Visualization', 'User Analytics', 'Responsive Design'],
      github: '#',
      live: '#',
    ...
    },
    {
      ...
      features: ['Team Collaboration', 'Deadline Tracking', 'Progress Reports', 'File Uploads'],
      github: '#',
      live: '#',
        ...
        <div className="max-w-7xl mx-auto">
          <div className={`transition-all duration-1000 ${isVisible.about ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-semibold mb-6">Hi, I'm a passionate MERN Stack Developer</h3>
                <p className="text-gray-300 mb-6 leading-relaxed">
                  With 1 year of hands-on experience in full-stack development, I specialize in building 
                  scalable web applications using MongoDB, Express.js, React.js, and Node.js. I'm passionate 
                  about creating efficient, user-friendly solutions that solve real-world problems.
                </p>
                <p className="text-gray-300 mb-6 leading-relaxed">
                  My journey started with a curiosity about how web applications work, and it has evolved 
                  into a career where I get to build amazing digital experiences every day. I love learning 
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-gray-900 p-6 rounded-lg">
                  ...
                  <p className="text-sm text-gray-400">React, JavaScript, CSS</p>
                </div>
                <div className="bg-gray-900 p-6 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {Object.entries(skills).map(([category, skillList]) => (
                  <div key={category} className="bg-gray-900 p-6 rounded-lg">
                    <h4 className="font-semibold mb-4 capitalize text-blue-400">{category}</h4>
              ...
              {experiences.map((exp, index) => (
                <div key={index} className="bg-gray-800 rounded-lg p-8 hover:bg-gray-750 transition-colors">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4">
                    ...
                    <span className="text-gray-400 mt-2 lg:mt-0">{exp.duration}</span>
                  </div>
                  <p className="text-gray-300 mb-4">{exp.description}</p>
                  <div>
                    <h5 className="font-medium mb-2 text-purple-400">Key Achievements:</h5>
              ...
              {projects.map((project, index) => (
                <div key={index} className="bg-gray-900 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      <h4 className="font-medium mb-2 text-purple-400">Technologies:</h4>
                      <div className="flex flex-wrap gap-2">
                        {project.tech.map((tech, techIndex) => (
                          <span key={techIndex} className="px-2 py-1 bg-gray-700 text-xs rounded-md">
                            {tech}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="mb-6">
                      <h4 className="font-medium mb-2 text-green-400">Features:</h4>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  <div className="flex gap-4 mt-8">
                    <a href="#" className="w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors">
                      <Github size={24} />
                    </a>
                    <a href="#" className="w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors">
                      <Linkedin size={24} />
      ...
      <footer className="bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} MERN Stack Developer Portfolio. Built with React & Tailwind CSS.
          </p>
        </div>
      </footer>
    </div>
